...
abstract class SimpleOrm
{
    ...
    public static function getTableName (): string
    {
        ...
        return $className::$table ?? Str::snake(Str::pluralStudly(class_basename($className)));
    }
     ...
     * @return string
     */
    public static function getTablePk (): string
    {
        $className = get_called_class();
     ...
     * @return string
     */
    private function parseValueType (mixed $value): string
    {
        // ints
        if (is_int($value))
            return 'i';
     ...
     *
     * @access public
     * @param object|bool $obj
     * @return object
     */
    public function parent (object|bool $obj = false): object
    {
     ...
     * @throws \Exception
     */
    public function revert (bool $return = false)
    {
        if ($return)
        {
            $ret = clone $this;
     ...
     * @return array | string
     */
    public function get (bool|string $fieldName = false): object|array|string
    {
        // return all data
        if ($fieldName === false)
     ...
     * @return array
     */
    public static function convertObjectToArray (object $object): object|array
    {
        if (!is_object($object))
            return $object;
     ...
     * @return void
     */
    public function set (string $fieldName, string $newValue)
    {
     ...
     * @return array | false
     */
    public function isModified (): bool|array
    {
     ...
     * @return void
     */
    private function modifiedFields (string $fieldName, string $newValue)
    {
     ...
     * @return mixed
     */
    public static function sql (string $sql, int $return = SimpleOrm::FETCH_MANY): mixed
    {
        // shortcuts
     ...
     * @return mixed
     */
    public static function count (string $sql): mixed
    {
     ...
     * @return mixed
     */
    public static function retrieveByField (string $field, mixed $value, int $return = SimpleOrm::FETCH_MANY): mixed
    {
        if (!is_string($field))
     ...
     * @return array
     */
    public static function buildSelectBoxValues (string $where = null): array
    {
